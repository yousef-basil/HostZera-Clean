...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="{{ route('back.services.create') }}" class="px-5 py-2.5 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 shadow-sm transition">
...
<div class="mb-8">
    <div class="flex flex-wrap gap-2 items-center">
        ...
        @foreach($categories as $cat)
            <a href="{{ route('back.services.index', ['category_id' => $cat->id]) }}" 
        ...
        <tbody class="divide-y divide-gray-100">
            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-6 py-4 space-x-2">
                    <a href="{{ route('back.services.edit', $service->id) }}" class="text-blue-600 hover:text-blue-800">Edit</a>
                    <form action="{{ route('back.services.destroy', $service->id) }}" method="POST" class="inline" onsubmit="return confirm('Delete this service?')">
                        @csrf
                        @method('DELETE')
