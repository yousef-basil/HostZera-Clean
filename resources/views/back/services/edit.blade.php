...
<div class="max-w-2xl bg-white rounded-xl shadow-sm border border-gray-100 p-8">
    <form action="{{ route('back.services.update', $service->id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mt-8 flex gap-4">
            ...
            <a href="{{ route('back.services.index') }}" class="px-6 py-2 bg-gray-100 text-gray-600 font-bold rounded-lg hover:bg-gray-200 transition">
                Cancel
            </a>
        </div>
    </form>
