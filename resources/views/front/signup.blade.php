...
<div class="login-page">
    <div class="login-container">
        ...
        <div class="title-section" style="margin-bottom: 30px;">
            <h1 style="font-size: 2rem; font-weight: 900; color: #1e1b4b;">Join Hostzera</h1>
            <p style="color: #6366f1;">Create your account and start deploying your vision.</p>
        </div>
        ...
        <div class="divider-premium">OR SIGN UP WITH EMAIL</div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                ...
                @error('email')
                    <div style="background: #fef2f2; border: 1px solid #fee2e2; padding: 12px; border-radius: 10px; margin-top: 10px;">
                        <span style="color:#ef4444;font-size:0.85rem;font-weight:600;">{{ $message }}</span>
                    </div>
                @enderror
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="login-btn-premium">Create Account</button>
        </form>

        <p style="text-align: center; margin-top: 2rem; font-size: 0.9rem; color: #64748b;">
            Already have an account? <a href="{{ route('login') }}" style="color: #8b5cf6; font-weight: 800; text-decoration: none;">Log in</a>
        </p>
    </div>

    <div class="visual-side" style="background: linear-gradient(135deg, #8b5cf6 0%, #4c1d95 100%); flex: 1.2;">
        <h2>Start Building Today</h2>
        <p>Your journey with premium hosting starts here. Join thousands of creators.</p>
    </div>
</div>
@endsection
