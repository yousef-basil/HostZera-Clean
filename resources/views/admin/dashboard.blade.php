...
<div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
    ...
    <div class="flex gap-4">
        <a href="{{ route('admin.services.create') }}" class="px-6 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition">
            Add New Service
        </a>
        <a href="{{ route('admin.users.index') }}" class="px-6 py-3 bg-gray-100 text-gray-700 font-bold rounded-lg hover:bg-gray-200 transition">
            Manage Users
        </a>
    </div>
</div>
