...
<div class="login-page">
    <div class="login-container">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                <div style="display: flex; justify-content: space-between;">
                    ...
                    <a href="{{ route('forgot-password') }}" style="font-size: 0.8rem; color: #2563eb; text-decoration: none; font-weight: 600;">Forgot password?</a>
                </div>
        ...
        <p style="text-align: center; margin-top: 2rem; font-size: 0.85rem; color: #6b7280;">
            New to Hostzera? <a href="{{ route('signup') }}" style="color: #2563eb; font-weight: 700; text-decoration: none;">Create an account</a>
        </p>
    </div>
